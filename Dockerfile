...
# copy requirements
COPY cvat/requirements/ /app/requirements

# install requirements
RUN python3 -m pip install --no-cache-dir -r /app/requirements/${DJANGO_CONFIGURATION}.txt

# rub all commands below as 'django' user
USER ${USER}
